...
namespace CodingChallenge.Data.Tests
{
    ...
    public class DataTests
    {
        ...
        public void TestResumenListaConMasTrapecios()
        {
            ...
            Assert.AreEqual("<h1>Shapes report</h1>3 Trapezoids | Area 54 | Perimeter 60 <br/>TOTAL:<br/>3 shapes Perimeter 54 Area 60", resumen);
        }
        ...
        public void TestResumenListaConMasTiposEnCastellano()
        {
            var formas = new List<FormaGeometrica>
            {
                ...
                new FormaGeometrica(FormaGeometrica.Circulo, 2.75m),
                new FormaGeometrica(FormaGeometrica.TrianguloEquilatero, 4.2m),
                new FormaGeometrica(FormaGeometrica.TrianguloEquilatero, 4, 3, 8)
            };

            var resumen = FormaGeometrica.Imprimir(formas, FormaGeometrica.Castellano);

            Assert.AreEqual(
                "<h1>Reporte de Formas</h1>2 Cuadrados | Area 29 | Perimetro 28 <br/>2 Círculos | Area 13,01 | Perimetro 18,06 <br/>3 Triángulos | Area 49,64 | Perimetro 51,6 <br/>1 Trapecio | Area 18 | Perimetro 20<br/>TOTAL:<br/>8 formas Perimetro 117,66 Area 109,65",
                resumen);
        }
    }
}
